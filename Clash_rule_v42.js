function main(params) {
    ...
    const regions = [
        ...
        },
        {
            ...
            localRegexes: [
                {
                    source: "印度尼西亚|印度尼西亞|印尼|雅加达|雅加達|🇮🇩|Indonesia|Jakarta",
                    flags: "i"
                },
                {
                    source: "(?:^|[|/·•][ ]*)ID(?:[ ]*(?:[|/_·•-]|[0-9])|$)|(?:^|[^A-Za-z0-9])IDN(?:[^A-Za-z]|$)",
                    flags: ""
                }
            ],
        ...
        },
        {
            ...
            localRegexes: [
                {
                    source: "印度([^尼]|$)|新德里|孟买|孟買|班加罗尔|班加羅爾|🇮🇳|(^|[^A-Za-z])India([^A-Za-z]|$)|Mumbai|Delhi|Bangalore",
                    flags: "i"
                },
                {
                    source: "(?:^|[^A-Za-z0-9])(?:IN|IND)(?:[^A-Za-z]|$)",
                    flags: ""
                }
            ],
        ...
        },
        {
            ...
            localRegexes: [
                {
                    source: "泰国|泰國|曼谷|🇹🇭|Thailand|Bangkok",
                    flags: "i"
                },
                {
                    source: "(?:^|[^A-Za-z0-9])(?:TH|THA)(?:[^A-Za-z]|$)",
                    flags: ""
                }
            ],
