function main(params) {
    ...
    const regions = [
        ...
        { name: "UK", regex: "(?i)(英国|英國|伦敦|倫敦|🇬🇧|(^|[^A-Za-z])UK([^A-Za-z]|$)|United[ -]?Kingdom|Britain|Great[ -]?Britain)", icon: "United_Kingdom.png" },
    ...
    apps.forEach(app => {
        groups.push({
            name: app.name,
            type: "select",
            icon: `https://fastly.jsdelivr.net/gh/shindgew/WHATSINStash@main/icon/${app.icon}`,
