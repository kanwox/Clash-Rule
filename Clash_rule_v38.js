function main(params) {
    ...
    const regions = [
        { name: "DE", regex: "(?i)(德国|德國|法兰克福|法蘭克福|🇩🇪|(^|[^A-Za-z])DE([^A-Za-z]|$)|Germany|Frankfurt)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/de.svg" },
        { name: "FR", regex: "(?i)(法国|法國|巴黎|🇫🇷|(^|[^A-Za-z])FR([^A-Za-z]|$)|France|Paris)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/fr.svg" },
        { name: "GB", regex: "(?i)(英国|英國|伦敦|倫敦|🇬🇧|(^|[^A-Za-z])UK([^A-Za-z]|$)|(^|[^A-Za-z])GB([^A-Za-z]|$)|United[ -]?Kingdom|England|London)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/gb.svg" },
        { name: "HK", regex: "(?i)(香港|🇭🇰|(^|[^A-Za-z])HK([^A-Za-z]|$)|Hong[ -]?Kong)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/hk.svg" },
        { name: "JP", regex: "(?i)(日本|东京|東京|大阪|🇯🇵|(^|[^A-Za-z])JP([^A-Za-z]|$)|Japan)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/jp.svg" },
        ...
        { name: "MY", regex: "(?i)(马来西亚|馬來西亞|吉隆坡|🇲🇾|(^|[^A-Za-z])MY([^A-Za-z]|$)|Malaysia)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/my.svg" },
        { name: "NL", regex: "(?i)(荷兰|荷蘭|阿姆斯特丹|🇳🇱|(^|[^A-Za-z])NL([^A-Za-z]|$)|Netherlands|Amsterdam)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/nl.svg" },
        { name: "SG", regex: "(?i)(新加坡|狮城|獅城|🇸🇬|(^|[^A-Za-z])SG([^A-Za-z]|$)|Singapore)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/sg.svg" },
        { name: "TW", regex: "(?i)(台湾|台灣|台北|新北|🇹🇼|(^|[^A-Za-z])TW([^A-Za-z]|$)|Taiwan)", icon: "https://raw.githubusercontent.com/HatScripts/circle-flags/gh-pages/flags/tw.svg" },
    ...
    // 这里做本地匹配时要去掉 (?i) 前缀改用 JS 的 i 标志；filter/exclude-filter 字段本身保持原样不动，那是给 Mihomo 核心用的
    ...
    const activeRegions = regions.filter(r => {
        const filterRe = toJsRegex(r.regex);
    ...
    groups.push({
        ...
        proxies: activeRegions.map(r => `${r.name} 均衡`)
    });
